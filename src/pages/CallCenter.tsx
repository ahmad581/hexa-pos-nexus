...
import { Phone, PhoneCall, Clock, User, MapPin, ShoppingCart, Plus } from "lucide-react";
...
export const CallCenter = () => {
  ...
  const handleTakeOrder = (call: Call) => {
    setActiveCall(call);
    setOrderType(call.orderType === "Delivery" ? "delivery" : call.orderType === "Pickup" ? "takeout" : "phone");
    setCustomerInfo({
      ...
      <div className="lg:col-span-2 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400">
              Manage calls for {selectedBranch?.name || 'All Branches'}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="bg-gray-800 border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-green-400">{activeCalls.length}</div>
