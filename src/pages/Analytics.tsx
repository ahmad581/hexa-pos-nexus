...
const dailySalesData = [
  { hour: "6AM", sales: 120, orders: 5, deletedOrders: 0, updatedOrders: 1 },
  { hour: "8AM", sales: 380, orders: 15, deletedOrders: 1, updatedOrders: 2 },
  { hour: "10AM", sales: 650, orders: 25, deletedOrders: 0, updatedOrders: 3 },
  { hour: "12PM", sales: 1200, orders: 45, deletedOrders: 2, updatedOrders: 8 },
  { hour: "2PM", sales: 950, orders: 35, deletedOrders: 1, updatedOrders: 5 },
  { hour: "4PM", sales: 580, orders: 20, deletedOrders: 0, updatedOrders: 2 },
  { hour: "6PM", sales: 1450, orders: 55, deletedOrders: 3, updatedOrders: 9 },
  { hour: "8PM", sales: 1780, orders: 65, deletedOrders: 2, updatedOrders: 12 },
  { hour: "10PM", sales: 1100, orders: 40, deletedOrders: 1, updatedOrders: 6 }
];
...
export const Analytics = () => {
  ...
  const exportReport = () => {
    const csvContent = [
      ["Hour", "Sales", "Orders", "Deleted Orders", "Updated Orders"],
