  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">{t('tablesPage.title')}</h1>
          <p className="text-muted-foreground">{t('tablesPage.monitor')}</p>
        </div>
        <div className="flex space-x-4">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-green-500 rounded-full"></div>
            <span className="text-sm text-muted-foreground">{t('tables.available')}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-red-500 rounded-full"></div>
            <span className="text-sm text-muted-foreground">{t('tables.occupied')}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
            <span className="text-sm text-muted-foreground">{t('tables.reserved')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-card border-border p-6">
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-sm">{t('tables.available')}</div>
          </div>
        </Card>
        <Card className="bg-card border-border p-6">
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-sm">{t('tables.occupied')}</div>
          </div>
        </Card>
        <Card className="bg-card border-border p-6">
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-sm">{t('tables.reserved')}</div>
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {tables.map((table) => {
          ...
          return (
            <Card key={table.id} className="bg-card border-border p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-foreground">{t('tables.tableNumber')} {table.number}</h3>
